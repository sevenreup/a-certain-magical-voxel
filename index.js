...
Module['FS_createPath']("/", "assets", true, true);
    ...
    loadPackage({"files": [{"filename": "/assets/README.md", "start": 0, "end": 163}], "remote_package_size": 163});

  })();

// end include: /tmp/tmpbga3jtpt.js
// include: /tmp/tmpx5vbojws.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpx5vbojws.js
// include: /tmp/tmplqrxzhx8.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmplqrxzhx8.js
...
var ASM_CONSTS = {
  123120: () => { if (document.fullscreenElement) return 1; },  
 123166: () => { return document.getElementById('canvas').width; },  
 123218: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123286: () => { document.exitFullscreen(); },  
 123313: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 123386: () => { if (document.fullscreenElement) return 1; },  
 123432: () => { return document.getElementById('canvas').width; },  
 123484: () => { return screen.width; },  
 123509: () => { document.exitFullscreen(); },  
 123536: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 123669: () => { return window.innerWidth; },  
 123695: () => { return window.innerHeight; },  
 123722: () => { if (document.fullscreenElement) return 1; },  
 123768: () => { return document.getElementById('canvas').width; },  
 123820: () => { return parseInt(document.getElementById('canvas').style.width); },  
 123888: () => { if (document.fullscreenElement) return 1; },  
 123934: () => { return document.getElementById('canvas').width; },  
 123986: () => { return screen.width; },  
 124011: () => { return window.innerWidth; },  
 124037: () => { return window.innerHeight; },  
 124064: () => { if (document.fullscreenElement) return 1; },  
 124110: () => { return document.getElementById('canvas').width; },  
 124162: () => { return screen.width; },  
 124187: () => { document.exitFullscreen(); },  
 124214: () => { if (document.fullscreenElement) return 1; },  
 124260: () => { return document.getElementById('canvas').width; },  
 124312: () => { return parseInt(document.getElementById('canvas').style.width); },  
 124380: () => { document.exitFullscreen(); },  
 124407: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 124465: () => { return screen.width; },  
 124490: () => { return screen.height; },  
 124516: () => { return window.screenX; },  
 124543: () => { return window.screenY; },  
 124570: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 124623: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 124694: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 124751: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 125007: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 125078: () => { if (document.fullscreenElement) return 1; },  
 125124: () => { return window.innerWidth; },  
 125150: () => { return window.innerHeight; },  
 125177: () => { if (document.pointerLockElement) return 1; }
};
